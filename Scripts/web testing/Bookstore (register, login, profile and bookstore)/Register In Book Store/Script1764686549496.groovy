...
WebUI.setText(findTestObject('Page_DEMOQA/register bookstore/input_First Name'), 'Jolie')

WebUI.setText(findTestObject('Page_DEMOQA/register bookstore/input_Last Name'), 'Felicia')

WebUI.setText(findTestObject('Page_DEMOQA/register bookstore/input_UserName'), 'joliefeliciaa')

WebUI.setText(findTestObject('Page_DEMOQA/register bookstore/input_Password'), '123456789abcD')
